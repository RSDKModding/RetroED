...
StageconfigEditorv3::StageconfigEditorv3(FormatHelpers::Stageconfig *scf, int globalObjCount,
                                         QWidget *parent)
    : m_stageconfig(scf), QDialog(parent), ui(new Ui::StageconfigEditorv3)
{
    ui->setupUi(this);
...
void StageconfigEditorv3::setupUI()
{
    ui->sectionList->blockSignals(true);
    ui->sectionList->setCurrentRow(-1);
    ui->sectionList->blockSignals(false);
