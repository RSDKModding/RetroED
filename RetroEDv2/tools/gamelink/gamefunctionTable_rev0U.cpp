...
void RegisterGlobalVariables(void **globals, int size, void (*initCB)(void *globals))
{
...
void InitFunctionTables()
{
    ...
    ADD_RSDK_FUNCTION(FunctionTable_RegisterObject, RegisterObjectv5U);
    ...
    ADD_RSDK_FUNCTION(FunctionTable_DrawDynamicAniTile, BlankFunction);
    ...
    ADD_RSDK_FUNCTION(FunctionTable_SetupCollisionConfig, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_SetPathGripSensors, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_FloorCollision, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_LWallCollision, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_RoofCollision, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_RWallCollision, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_FindFloorPosition, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_FindLWallPosition, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_FindRoofPosition, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_FindRWallPosition, BlankFunction);
    ...
    ADD_RSDK_FUNCTION(FunctionTable_CopyCollisionMask, BlankFunction);
    ADD_RSDK_FUNCTION(FunctionTable_GetCollisionInfo, BlankFunction);
    ...
    ADD_RSDK_FUNCTION(FunctionTable_StopAllSfx, BlankFunction);
    ...
    ADD_API_FUNCTION(APITable_GetDefaultGamepadType, BlankFunction);
