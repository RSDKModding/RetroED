...
ColorListWidget::ColorListWidget(QWidget *parent) : AbstractWidgetList(parent), p(new Private)
{
...
void ColorListWidget::append_widget(int col)
{
    ...
    connect(this, &ColorListWidget::wheelFlagsChanged, cbs, &ColorSelector::setWheelFlags);
    appendWidget(cbs);
    setRowHeight(count() - 1, 22);
}

ColorWheel::DisplayFlags ColorListWidget::wheelFlags() const { return p->wheel_flags; }
