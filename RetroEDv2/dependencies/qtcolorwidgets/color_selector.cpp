...
ColorSelector::ColorSelector(QWidget *parent) : ColorPreview(parent), p(new Private(this))
{
    ...
    connect(p->dialog, &ColorDialog::wheelFlagsChanged, this, &ColorSelector::wheelFlagsChanged);
...
ColorSelector::UpdateMode ColorSelector::updateMode() const { return p->update_mode; }
...
Qt::WindowModality ColorSelector::dialogModality() const { return p->dialog->windowModality(); }
...
ColorWheel::DisplayFlags ColorSelector::wheelFlags() const { return p->dialog->wheelFlags(); }
...
void ColorSelector::setWheelFlags(ColorWheel::DisplayFlags flags) { p->dialog->setWheelFlags(flags); }
