...
ColorDialog::~ColorDialog() { delete p; }

QSize ColorDialog::sizeHint() const { return QSize(400, 0); }

ColorWheel::DisplayFlags ColorDialog::wheelFlags() const { return p->ui.wheel->displayFlags(); }
...
void ColorDialog::setWheelFlags(ColorWheel::DisplayFlags flags) { p->ui.wheel->setDisplayFlags(flags); }
...
ColorDialog::ButtonMode ColorDialog::buttonMode() const { return p->button_mode; }
...
void ColorDialog::on_edit_hex_colorChanged(const QColor &color) { setColorInternal(color); }
